    ...
    <main>
        ...
        <div class="row d-flex flex-row">
          <div class="col-lg-4 d-flex flex-row gap-2 align-items-center">
            ...
            <input type="text" id="filter_tanggal" name ="filter_tanggal" class="drilldown-form-control" required>
          </div>
          <div class="col-lg-4 d-flex flex-row gap-2 align-items-center">           
        ...
        <div class="row mx-3"> 
        <table class="table table-striped table-hover table-bordered dataTable" id="report_table">
          <thead>
              <tr>
                  <th>ID Barang</th>
                  <th>Nama Barang </th>
